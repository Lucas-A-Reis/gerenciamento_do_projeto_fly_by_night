...
--
-- Banco de dados: `flybynight_lucasaguiar`
--
...
(8, 'william eventos'),
(9, 'emerson climatização'),
(10, 'atacadão do ernane'),
(11, 'fornecildo fornecerson');
...
INSERT INTO `produto` (`id`, `nome`, `descricao`, `preco`, `quantidade`, `fornecedor_id`) VALUES
(1, 'Smartphone Galaxy S23', 'Equipamento com sistema android e câmera full HD', 2600.60, 15, 1),
(2, 'TV LED', 'Tela de 50 polegadas, 4k, 4 entradas HDMI e etc e tal', 3420.00, 12, 1),
(3, 'Senhor dos Anéis: As Duas Torres', 'Volume 2 da triologia Senhor dos Anéis', 125.00, 100, 4),
(14, 'Ghost Rider', 'Livro contando a história de vida do Neil Peart', 125.00, 60, 4),
(15, 'Senhor dos Anéis: A Sociedade do Anel', 'Primeiro livro da saga Senhor dos Anéis', 125.00, 50, 4);
...
ALTER TABLE `lojas_produtos`
  ...
  ADD CONSTRAINT `lojas_produtos_ibfk_2` FOREIGN KEY (`produto_id`) REFERENCES `produto` (`id`);

--
-- Restrições para tabelas `produto`
--
ALTER TABLE `produto`
  ADD CONSTRAINT `produto_ibfk_1` FOREIGN KEY (`fornecedor_id`) REFERENCES `fornecedores` (`id`);
COMMIT;
